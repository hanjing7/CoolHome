  ...
  <tr>
    ...
    <td width="581" valign="top" bgcolor="#FFFFFF"><table width="550" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr bgcolor="#FDE9C9">
          <td height="25" colspan="4"><div align="center" style="color: #990000">Creation评论</div></td>
        </tr>
        <?php
	   ...
	   if($total==0)
	   {
	     echo " This CreationTemperarily No评论信息!";
	   }
	   else
	   {
	       $pagesize=3;
      ...
      <table width="550" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><div align="right"> &nbsp;Our Site  Totally     This Creation评论&nbsp;
                  <?php
		   echo $total;
		  ?>
&nbsp;条&nbsp; Each    Page  Show &nbsp;<?php echo $pagesize;?>&nbsp;条&nbsp; The &nbsp;<?php echo $page;?>&nbsp; Page  /Total&nbsp;<?php echo $pagecount; ?>&nbsp; Page  
        <?php
		  ...
		  {
		  ?>
        <a href="showpl.php?page=1" title="Home Page  "><font face="webdings"> 9 </font></a> <a href="showpl.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>&spid=<?php echo $spid;?>&id=<?php echo $id;?>" title="前一 Page  "><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
        ...
        <a href="showpl.php?page=<?php echo $i;?>&spid=<?php echo $spid;?>&id=<?php echo $id;?>"><?php echo $i;?></a>
        <?php }?>
        <a href="showpl.php?page=<?php echo $page-1;?>&spid=<?php echo $spid;?>&id=<?php echo $id;?>" title="Next Page  "><font face="webdings"> 8 </font></a> <a href="editgoods.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>&spid=<?php echo $spid;?>&id=<?php echo $id;?>" title="尾 Page  "><font face="webdings"> : </font></a>
        <?php }?>
          </div></td>
        </tr>
      </table></td>

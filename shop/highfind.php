...
&nbsp;
                ...
                <tr>
                  <td height="25" bgcolor="#FFFFFF"><div align="center">Creation Category 别:</div></td>
                  <td height="25" colspan="3" bgcolor="#FFFFFF"><div align="left">
                      <select name="lb">
                        <?php
				 ...
				 if($info==false)
				   {
				     echo " <option>Our Site Temperarily NoCreation Category 别</option>";
				   }
				  else
				  { 
				    do
          ...
          <tr>
            <td height="25" bgcolor="#FFFFFF"><div align="center">
                <input name="submit2" type="submit" class="buttoncss" value="开始Search ">
            </div></td>
          </tr>
        </form>
    </table></td>

  ...
  <tr>
    ...
    <td width="547"><div align="right">
	 ...
	 <?php
		...
		<a href="admingonggao.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="前一 Page  "><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
        ...
        <a href="admingonggao.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="Next Page  "><font face="webdings"> 8 </font></a>
		 <a href="admingonggao.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="尾 Page  "><font face="webdings"> : </font></a>
        <?php }?>
		</div></td>
  </tr>
</table>

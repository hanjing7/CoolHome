...
?></td>
    <td width="581" align="center" valign="top" bgcolor="#FFFFFF"><table width="557" height="6" border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="530" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="25" bgcolor="#FFEDBF">&nbsp;&nbsp;Creation信息</td>
        </tr>
      </table>
          ...
          <tr>
		   ...
		   ?>
			  ...
			  ?>
                  ...
                  <td width="92" height="20" align="left" bgcolor="#FFFFFF"><div align="center">Creation Name：</div></td>
                ...
                <tr>
                  <td height="20" align="left" bgcolor="#FFFFFF"><div align="center"> Premium  Price  ：</div></td>
                  <td width="134" bgcolor="#FFFFFF"><div align="left">&nbsp;<?php echo $info->huiyuanjia;?></div></td>
                  <td width="100" bgcolor="#FFFFFF"><div align="center">市场 Price  ：</div></td>
                  <td width="129" bgcolor="#FFFFFF"><div align="left">&nbsp;<?php echo $info->shichangjia;?></div></td>
                </tr>
                <tr>
                  <td height="20" align="left" bgcolor="#FFFFFF"><div align="center"> Level ：</div></td>
                  <td width="134" bgcolor="#FFFFFF"><div align="left">&nbsp;<?php echo $info->dengji;?></div></td>
                  <td width="100" bgcolor="#FFFFFF"><div align="center"> Tag ：</div></td>
                  <td width="129" bgcolor="#FFFFFF"><div align="left">&nbsp;<?php echo $info->pinpai;?></div></td>
                </tr>
                <tr>
                  <td height="20" align="left" bgcolor="#FFFFFF"><div align="center"> Model   ：</div></td>
                  <td width="134" bgcolor="#FFFFFF"><div align="left">&nbsp;<?php echo $info->xinghao;?></div></td>
                  <td width="100" bgcolor="#FFFFFF"><div align="center"> Amount ：</div></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $info->jianjie;?></div></td>
        ...
        <table width="530" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><div align="right"><a href="addgouwuche.php?id=<?php echo $info->id;?>">放入Collection </a>&nbsp;&nbsp;</div></td>
          </tr>
        </table>
        <?php
  ...
  <table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
		    ...
		    function chkinput(form)
			{
			   if(form.title.value=="")
			   {
			     alert(" Please    type in   评论主题!");
				 form.title.select();
				 return(false);
			   }
			   if(form.content.value=="")
			   {
			     alert(" Please    type in   评论内容!");
				 form.content.select();
				 return(false);
			   }
			   return(true);
...
&nbsp;&nbsp;&nbsp;<a href="showpl.php?id=<?php echo $_GET['id'];?>">查看 This Creation评论</a></div></td>
            </tr>
          </table>
      </form>
    <?php

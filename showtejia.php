  ...
  <tr>
    ...
    <td width="561" align="center" valign="top" bgcolor="#FFFFFF"><table width="550" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <?php
	   ...
	   if($total==0)
	   {
	     echo "Our Site Temperarily No特 Price   Product !";
	   }
	   else
	   {
      ...
      <table width="550" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><div align="right"> &nbsp;Our Site  Totally    特 Price   Product &nbsp;
                  <?php
		   echo $total;
		  ?>
&nbsp; items  &nbsp; Each    Page  Show &nbsp;<?php echo $pagesize;?>&nbsp; items  &nbsp; The &nbsp;<?php echo $page;?>&nbsp; Page  /Total&nbsp;<?php echo $pagecount; ?>&nbsp; Page  
        <?php
		  ...
		  {
		  ?>
        <a href="showtejia.php?page=1" title="Home Page  "><font face="webdings"> 9 </font></a> <a href="showtejia.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="前一 Page  "><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
        ...
        <a href="showtejia.php?page=<?php echo $i;?>"><?php echo $i;?></a>
        <?php }?>
        <a href="showtejia.php?page=<?php echo $page-1;?>" title="Next Page  "><font face="webdings"> 8 </font></a> <a href="showtejia.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="尾 Page  "><font face="webdings"> : </font></a>
        <?php }?>
          </div></td>
        </tr>
      </table>

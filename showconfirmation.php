...
<?php
  ...
  $dingdanhao=$_GET['dd'];
  $sql=mysql_query("select * from tb_order where dingdanhao='".$dingdanhao."'",$conn);
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="306" bgcolor="#FFFFFF"><table width="600"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="20" bgcolor="#8A87CC"><div align="center" class="style7">Congratulations <?php echo $_SESSION['username'];?>! you order has been submitted successfully! Detailed Order INFO:</div></td>
      </tr>
      <tr>

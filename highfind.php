    ...
    <td width="561" align="center" valign="top" bgcolor="#FFFFFF"><table width="550" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
	    ...
	    function chkinput1(form)
		{
		  if(form.name.value=="")
		   {
		     alert(" Please    type in   ¹Ø¼ü×Ö!");
			 form.name.select();
			 return(false);
		   }
		  if(form.jg.value=="")
		   {
		     alert(" Please    type in   Creation Price  !");
			 form.jg.select();
			 return(false);
		   }
		   return(true);
        ...
        <form name="form1" method="post" action="findsp.php" onSubmit="return chkinput1(this)">
          ...
          <tr>
            <td height="50" bgcolor="#8A87CC"><table width="400" height="80" border="0" cellpadding="0" cellspacing="1">
                ...
                <tr>
                  <td height="25" bgcolor="#FFFFFF"><div align="center"> Premium  Price  :</div></td>
                  <td height="25" colspan="3" bgcolor="#FFFFFF"><div align="left">
                      <select name="dx">
                        <option selected value="1">´óÓÚ</option>
                        <option value="-1">Ð¡ÓÚ</option>
                        <option value="0">µÈÓÚ</option>
                      </select>
&nbsp;
                ...
                <tr>
                  <td height="25" bgcolor="#FFFFFF"><div align="center">Creation Category ±ð:</div></td>
                  <td height="25" colspan="3" bgcolor="#FFFFFF"><div align="left">
                      <select name="lb">
                        <?php
				 ...
				 if($info==false)
				   {
				     echo " <option>Our Site Temperarily NoCreation Category ±ð</option>";
				   }
				  else
				  { 
				    do
          ...
          <tr>
            <td height="25" bgcolor="#FFFFFF"><div align="center">
                <input name="submit2" type="submit" class="buttoncss" value="¿ªÊ¼Search ">
            </div></td>
          </tr>
        </form>
    </table></td>

    ...
    <td width="766" align="center" valign="top" bgcolor="#FFFFFF">      <table width="557" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td height="20"><div align="center"><a href="showmoreannouncements.php?id=<?php echo $info1['id'];?>">View </a></div></td>
        </tr>
        <?php
	    }
...
&nbsp;&nbsp; Each    Page  Show &nbsp;<?php echo $pagesize;?>&nbsp;&nbsp; The &nbsp;<?php echo $page;?>&nbsp; Page  /Total&nbsp;<?php echo $pagecount; ?>&nbsp; Page  
        <?php
		  ...
		  {
		  ?>
        <a href="showannouncements.php?page=1" title="Home Page  "><font face="webdings"> 9 </font></a> <a href="showannouncements.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="ǰһ Page  "><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
		    for($i=1;$i<=$pagecount;$i++){
		  ?>
        <a href="showannouncements.php?page=<?php echo $i;?>"><?php echo $i;?></a>
        <?php
		     }
		   }else{
		   for($i=1;$i<=4;$i++){	 
        ...
        <a href="showannouncements.php?page=<?php echo $i;?>"><?php echo $i;?></a>
        <?php }?>
        <a href="showannouncements.php?page=<?php echo $page-1;?>" title="Next Page  "><font face="webdings"> 8 </font></a> <a href="showannouncements.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="β Page  "><font face="webdings"> : </font></a>
        <?php }?>
            </div></td>
        </tr>
      </table>

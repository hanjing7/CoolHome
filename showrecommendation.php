...
<table width="800" height="438" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td width="800" align="center" valign="top" bgcolor="#FFFFFF"><table width="550" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <?php
	   $sql=mysql_query("select count(*) as total from tb_product where tuijian=1 ",$conn);
        ...
        <?php
		   ...
		   if ($total<=$pagesize){
			...
			if(($_GET['page'])==""){
             ...
             $sql1=mysql_query("select * from tb_product where tuijian=1 order by addtime desc limit ".($page-1)*$pagesize.",$pagesize ",$conn);
      ...
      <table width="550" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><div align="right">Total number of products:&nbsp;
		   ...
		   echo $total;
		  ?>
&nbsp; items  &nbsp; Each    Page  Shows &nbsp;<?php echo $pagesize;?>&nbsp; items  &nbsp; &nbsp;<?php echo $page;?>&nbsp; Page  /Total&nbsp;<?php echo $pagecount; ?>&nbsp; Page
        <?php
		  if($page>=2)
		  {
		  ?>
        <a href="showrecommendation.php?page=1" title="Home Page  "><font face="webdings"> 9 </font></a> <a href="showrecommendation.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="ǰһ Page  "><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
		    for($i=1;$i<=$pagecount;$i++){
		  ?>
        <a href="showrecommendation.php?page=<?php echo $i;?>"><?php echo $i;?></a>
        <?php
		     }
		   }else{
		   for($i=1;$i<=4;$i++){	 
        ...
        <a href="showrecommendation.php?page=<?php echo $i;?>"><?php echo $i;?></a>
        <?php }?>
        <a href="showrecommendation.php?page=<?php echo $page-1;?>" title="Next Page  "><font face="webdings"> 8 </font></a> <a href="showrecommendation.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="β Page  "><font face="webdings"> : </font></a>
        <?php }?>
          </div></td>
        </tr>
      </table>

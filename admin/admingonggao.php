  ...
  <tr>
    <td height="50" bgcolor="#666666"><table width="750" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
	  ...
	  <tr>
	    ...
	    <td height="25" bgcolor="#FFFFFF"><div align="center"><a href="editgonggao.php?id=<?php echo $info1['id'];?>">View Edit </a></div></td>
	  </tr>
	  <?php
	       }
...
<table width="750" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="203"><div align="left"><input type="submit" value="Delete��Option" class="buttoncss">&nbsp;&nbsp;<input type="reset" value="ȡ��Delete" class="buttoncss"></div></td>
    <td width="547"><div align="right">
	 ...
	 <?php
		...
		<a href="admingonggao.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="Prev Page  "><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
        ...
        <a href="admingonggao.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="Next Page  "><font face="webdings"> 8 </font></a>
		 <a href="admingonggao.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="End Page  "><font face="webdings"> : </font></a>
        <?php }?>
		</div></td>
  </tr>
</table>

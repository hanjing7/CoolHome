...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="20" bgcolor="#FFCF60"><div align="center" class="style1">查看Order  </div></td>
  </tr>
  <tr>
    <td height="40" bgcolor="#666666"><table width="750" height="44" border="0" align="center" cellpadding="0" cellspacing="1">
	  ...
	  <tr>
        ...
        <td width="141" bgcolor="#FFFFFF"><div align="center">Order 状态</div></td>
  ...
  <tr>
	...
	Our Site  Totally    Order 
        ...
        <a href="lookdd.php?page=1" title="Home Page  "><font face="webdings"> 9 </font></a>
		 <a href="lookdd.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="前一 Page  "><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
		...
		<a href="lookdd.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="尾 Page  "><font face="webdings"> : </font></a>
        <?php }?>

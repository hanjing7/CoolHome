  ...
  <tr>
    <td bgcolor="#333333"><table width="750" border="0" align="center" cellpadding="0" cellspacing="1">
     <form name="form1" method="post" action="saveorder.php?id=<?php echo $info['id'];?>">
	  <tr>
        <td width="70" height="25" bgcolor="#FFFFFF"><div align="center" class="style3">Order 编Number ：</div></td>
...
<table width="750" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="13"><div align="left">
      <div align="center" class="style2">注：一旦Creation确定发货， This Creation Amount 将自动从库存中相应减少，并且Not 可更改！</div>
    </div></td>
  </tr>
</table>
  ...
  <tr>
    <td bgcolor="#CCCCCC"><table width="750" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr bgcolor="#FFCF60">
        ...
        <td width="106"><div align="center" class="style4">市场 Price  </div></td>
        <td width="106"><div align="center" class="style4"> Premium  Price  </div></td>
        <td width="106" height="20"><div align="center" class="style4">成交 Price  </div></td>
...
<table width="750" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><div align="right" class="style3">合计：<?php echo $total;?>&nbsp;Dollar&nbsp;</div></td>
  </tr>
</table>
<table width="750" height="195" border="0" align="center" cellpadding="0" cellspacing="1">
  <tr>
    <td height="193" bgcolor="#333333"><table width="750" height="151" border="0" align="center" cellpadding="0" cellspacing="1">
      ...
      <tr>
        <td width="120" height="25" bgcolor="#FFFFFF"><div align="center" class="style3">收货人Full Name ：</div></td>
      ...
      <tr>
        <td height="25" bgcolor="#FFFFFF"><div align="center" class="style3">电子邮 items  ：</div></td>

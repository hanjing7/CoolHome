...
<table width="600" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	&nbsp;Our Site  Totally     Register User &nbsp;<?php
		...
		<a href="edituser.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="Prev Page  "><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
		...
		<a href="edituser.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="End Page  "><font face="webdings"> : </font></a>
        <?php }?>

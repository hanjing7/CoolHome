...
$info=mysql_fetch_array($sql);
 if($info==false)
  {
    echo "Our Site Temperarily NoCreation Category 别!";
   }
  else
  {
?>
   ...
   <form name="form1" method="post" action="deletelb.php">
    ...
    <tr>
      <td height="20" bgcolor="#666666"><table width="400" border="0" align="center" cellpadding="0" cellspacing="1">
        <tr>
          <td width="253" height="20" bgcolor="#FFFFFF"><div align="center"> Category 别 Name</div></td>
          <td width="144" bgcolor="#FFFFFF"><div align="center">Operation</div></td>
        </tr>
		<?php
		  do
		  {
		...
		<tr>
          ...
          <td height="20" bgcolor="#FFFFFF"><div align="center"><input type="submit" value="DeleteOption" class="buttoncss"></div></td>
        </tr>
      </table></td>
    </tr>
	</form>

...
<?php
	   ...
	   if($total==0)
	   {
	     echo "Our Site Temperarily NoUser ����Comment !";
	   }
	   else
	   {
  ...
  <tr>
	...
	&nbsp;Our Site  Totally    ��Comment &nbsp;<?php
        ...
        <?php
		  ...
		  {
		  ?>
        <a href="editpinglun.php?page=1" title="Home Page  "><font face="webdings"> 9 </font></a> 
		<a href="editpinglun.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="Prev Page  "><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
		...
		<a href="editpinglun.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="End Page  "><font face="webdings"> : </font></a>
        <?php }?>

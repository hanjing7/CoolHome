 ...
 <form name="form2" method="post" action="deletepingjia.php"> 
  ...
  <tr>
	...
	&nbsp;Our Site  Totally    用评论&nbsp;<?php
		...
		<a href="editpinglun.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="前一 Page  "><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
		...
		<a href="editpinglun.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="尾 Page  "><font face="webdings"> : </font></a>
        <?php }?>

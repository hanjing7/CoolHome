...
<form name="form1" method="post" action="deleteleaveword.php">
  ...
  <tr> 
    <td height="40" colspan="2" bgcolor="#333333"><table width="750"  border="0" align="center" cellpadding="0" cellspacing="1">
        <tr> 
          <td width="357" height="20" bgcolor="#FFFFFF"><div align="center"> MessageTopic</div></td>
          <td width="80" bgcolor="#FFFFFF"><div align="center"> Messager</div></td>
          <td width="156" bgcolor="#FFFFFF"><div align="center"> MessageTime</div></td>
          <td width="93" bgcolor="#FFFFFF"><div align="center">Operation</div></td>
          <td width="58" bgcolor="#FFFFFF"><div align="center">Delete</div></td>
        </tr>
		 <?php
  ...
  <tr> 
    ...
    <td width="98" bgcolor="#FFFFFF"><div align="center"><input type="submit" value="Delete Option" class="buttoncss"></div></td>
  </tr>
  </form>
</table>
	<?php

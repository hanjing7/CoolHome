...
<form name="form1" method="post" action="deleteleaveword.php">
  ...
  <tr> 
	...
	&nbsp;Our Site  Totally    User  Message&nbsp;<?php
		...
		<a href="lookleaveword.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="前一 Page  "><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
		...
		<a href="lookleaveword.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="尾 Page  "><font face="webdings"> : </font></a>
        <?php }?>

  ...
  <tr>
    <td height="75" bgcolor="#666666"><table width="750" height="86" border="0" cellpadding="0" cellspacing="1">
      ...
      <tr>
        ...
        <td width="60" bgcolor="#FFFFFF"><div align="center">市场 Price  </div></td>
        <td width="61" bgcolor="#FFFFFF"><div align="center"> Premium  Price  </div></td>
        <td width="60" bgcolor="#FFFFFF"><div align="center">卖出</div></td>
        <td width="112" bgcolor="#FFFFFF"><div align="center">Add to 时间</div></td>
...
<table width="750" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="585"><div align="right">&nbsp;Our Site  Totally    货物
        <?php
		   echo $total;
		  ?>
        ...
        <?php
		  ...
		  {
		  ?>
        <a href="editgoods.php?page=1" title="Home Page  "><font face="webdings"> 9 </font></a> <a href="editgoods.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="前一 Page  "><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
        ...
        <a href="editgoods.php?page=<?php echo $i;?>"><?php echo $i;?></a>
        <?php }?>
        <a href="editgoods.php?page=<?php echo $page-1;?>" title="Next Page  "><font face="webdings"> 8 </font></a> <a href="editgoods.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="尾 Page  "><font face="webdings"> : </font></a>
        <?php }?>
    </div></td>
  </tr>
</table>
